...
against efficiency. When full 64-bit precision isn't required — which is
increasingly the regime that matters for ML workloads — the discovered
programs can reach orders of magnitude more precision than classical
approaches for the same operation budget.
